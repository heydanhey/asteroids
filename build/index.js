...
function Asteroid({ asteroid }) {
  return /* @__PURE__ */ React.createElement("div", {
    ...
    style: {
      ...
      left: Math.abs(asteroid.close_approach_data[0].miss_distance.miles / 1e4),
      top: asteroid.top
    }
  });
}
...
function Index() {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(import_react_tooltip.default, {
    multiline: true
  }), /* @__PURE__ */ React.createElement(Earth, null), asteroids.map((asteroid) => /* @__PURE__ */ React.createElement(Asteroid, {
    asteroid
  })));
}
